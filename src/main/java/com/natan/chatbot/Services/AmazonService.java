...
public class AmazonService {
     ...
     * @return - a list of products from amazon as string
     * @throws IOException
     */
    ...
    /**
     * this method get the html of the amazon search page and parse it to get the products
     * @param keyword - the keyword to search for
     * @return Html of the amazon search page as string
     * @throws IOException
     */
    ...
    /**
     * The method parse the response from amazon and return a list of products using regex
     * @param html - the html to be parsed
     * @return - a list of products
     */
    private String parseProductHtml(String html) {
        Map<Integer, AmazonItem> itemsMap = new HashMap<>();
        String res = "";
        Matcher matcher = PRODUCT_PATTERN.matcher(html);
        int  itemsCounter = 1;
        while (matcher.find()) {
//            res += matcher.group(1) + " - " + matcher.group(2) + ", price: " + matcher.group(3) + "<br/>\n";
            String item = matcher.group(1) + " - " + matcher.group(2) + ", price: " + matcher.group(3);
            res += item;
            AmazonItem amazonItem = new AmazonItem(matcher.group(1), matcher.group(3), matcher.group(2));
            itemsMap.put(itemsCounter++, amazonItem);
        }
        return res;
//        return itemsMap;
    }
